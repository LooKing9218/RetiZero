...
"""
Modifed from flair.modeling.timm_models. https://github.com/rwightman/pytorch-image-models/blob/master/timm/models/vision_transformer.py
...
from retrieval.modeling.timm_models.layers import DropPath, to_2tuple, trunc_normal_, _assert
