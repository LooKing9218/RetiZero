...
from clip_modules.modeling.timm_models.layers import BatchNormAct2d, SyncBatchNormAct, FrozenBatchNormAct2d,\
...
def _freeze_unfreeze(root_module, submodules=[], include_bn_running_stats=True, mode='freeze'):
    ...
    if isinstance(root_module, (
        ...
        raise AssertionError(
            ...
            "`clip_modules.modeling.timm_models.utils.model.freeze_batch_norm_2d` or `clip_modules.modeling.timm_models.utils.model.unfreeze_batch_norm_2d` instead.")
...
def freeze(root_module, submodules=[], include_bn_running_stats=True):
    ...
    Hint: If you want to freeze batch norm ONLY, use `clip_modules.modeling.timm_models.utils.model.freeze_batch_norm_2d`.

    Examples::

        >>> model = clip_modules.modeling.timm_models.create_model('resnet18')
