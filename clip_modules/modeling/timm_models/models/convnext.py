...
from clip_modules.modeling.timm_models.data import IMAGENET_DEFAULT_MEAN, IMAGENET_DEFAULT_STD, OPENAI_CLIP_MEAN, OPENAI_CLIP_STD
from clip_modules.modeling.timm_models.layers import trunc_normal_, AvgPool2dSame, DropPath, Mlp, GlobalResponseNormMlp, \
    LayerNorm2d, LayerNorm, create_conv2d, get_act_layer, make_divisible, to_ntuple
from clip_modules.modeling.timm_models.layers import NormMlpClassifierHead, ClassifierHead
