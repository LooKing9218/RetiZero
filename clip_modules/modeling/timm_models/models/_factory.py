...
from clip_modules.modeling.timm_models.layers import set_layer_config
...
def create_model(
    ...
    <Tip>
        **kwargs will be passed through entrypoint fn to ``clip_modules.modeling.timm_models.models.build_model_with_cfg()``
