...
from clip_modules.modeling.timm_models.layers import Conv2dSame, ScaledStdConv2dSame, CondConv2d, StdConv2dSame
from clip_modules.modeling.timm_models.layers.non_local_attn import BilinearAttnTransform
from clip_modules.modeling.timm_models.layers.pool2d_same import MaxPool2dSame, AvgPool2dSame
from clip_modules.modeling.timm_models.layers.norm_act import (
    BatchNormAct2d,
    SyncBatchNormAct,
...
# NOTE: By default, any modules from clip_modules.modeling.timm_models.models.layers that we want to treat as leaf modules go here
# BUT modules from clip_modules.modeling.timm_models.models should use the registration mechanism below
_leaf_modules = {
...
try:
    from clip_modules.modeling.timm_models.layers import InplaceAbn
...
def register_notrace_module(module: Type[nn.Module]):
    """
    Any module not under clip_modules.modeling.timm_models.models.layers should get this decorator if we don't want to trace through it.
    """
